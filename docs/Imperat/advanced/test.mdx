---
sidebar_position: 20
title: Command Hierarchy Diagram Example
---

# Example: Complex Command Structure

Suppose you have a root command `/manage` for a server management framework. This command has several subcommands and arguments, demonstrating advanced features:
...
Below is the command tree for `/manage` and its subcommands/arguments:
